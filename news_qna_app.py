...
/* ===== 프레임(흰 영역): 화면 비율 기반 높이 + 내부 스크롤 컨테이너 ===== */
.block-container > :first-child{
  position: relative !important;
  height: clamp(620px, 82vh, 860px);   /* ← 화면비율에 맞는 고정 느낌 */
...
/* ===== 프레임 하단 절대 고정 입력바 (.screen-body 위를 덮지 않도록 부모가 relative임) ===== */
.chat-dock{
...
/* 헤더 정리 */
[data-testid="stHeader"]{ background:transparent !重要; border:0 !important; }

/* 빈 입력바 래퍼가 렌더되면 숨김(안전장치) */
